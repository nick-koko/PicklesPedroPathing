...
public class FourOrMoreSampleAutoPedro_TEST extends OpMode {
    ...
    Pose dumpPoseLeftSideSample = new Pose(16.06, 126.16, Math.toRadians(-45));
    Pose dumpPoseLeftSideFromSamples = new Pose(16.06, 126.16, Math.toRadians(-45));
    Pose dumpPoseLeftSideFromSamples2 = new Pose(16.06, 126.16, Math.toRadians(-45));
    Pose dumpPoseLeftSideFromSamples3 = new Pose(16.06, 126.16, Math.toRadians(-45));
    ...
    //change TOP_POSITION to something less if needed (480 is max)
    int subIntakeSlideMaxEncoder = 160; //ntakeSlideAction.TOP_POSITION;
    ...
    public void buildPaths() {
        ...
        SampleToBucket3 = follower.pathBuilder()
                ...
                .setConstantHeadingInterpolation(dumpPoseLeftSideFromSamples.getHeading())
                .setZeroPowerAccelerationMultiplier(3.5)
                .build();
        ...
        SampleToBucket5 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(secondSamplePoseLeftSideSample.getHeading(), dumpPoseLeftSideFromSamples2.getHeading())

                .addPath(
                        // Line 3
                        new BezierLine(
                                new Point(19.066, 123.166, Point.CARTESIAN),
                                new Point(dumpPoseLeftSideFromSamples2)
                        )
                )
                .setConstantHeadingInterpolation(dumpPoseLeftSideFromSamples2.getHeading())
                .setZeroPowerAccelerationMultiplier(3.5)
                .build();
        ...
        Actions.runBlocking(
                new SequentialAction(
                   /*     new ParallelAction(
                                ...
                                new SequentialAction(
                                        new SleepAction(1),
                                        outtakeDump.bucketPosition()    //first sample in bucket
                                )
                        ),
                        new SleepAction(0.2),
                        new ParallelAction(
                        ...
                        new ParallelAction(
                                ...
                                new SequentialAction(
                                        ...
                                        new ParallelAction(
                                                ...
                                                new SequentialAction(
                                                        new SleepAction(0.8),
                                                        outtakeDump.bucketPosition()    //second sample in bucket
                                                )
                                        )
                                )
                        ),
                        ...
                        new ParallelAction(
                            ...
                            new SequentialAction(
                                ...
                                new ParallelAction(
                                        ...
                                        new SequentialAction(
                                                new SleepAction(0.8),
                                                outtakeDump.bucketPosition()    //third sample in bucket
                                        )
                                )
                            )
                        ),
                        ...
                        new SequentialAction(
                                new SleepAction(.5),
                                intakeSlide.extendIntoSubIntakeSlide(subIntakeSlideMaxEncoder)
                                //new SleepAction(1)
                        )
