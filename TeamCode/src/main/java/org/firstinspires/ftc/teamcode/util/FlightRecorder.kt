...
// had to add the LogWriter class here, originally it was included in the RoadRunner dependency that was removed
private class LogWriter(private val outputStream: OutputStream) {
    fun write(ch: String, o: Any) {
        val timestamp = System.nanoTime()
        val line = "$timestamp,$ch,${o.toString()}\n"
