...
/*
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        outtakeSlide.extendAction(),
                        new ParallelAction(
                                followOhDip7Path,           //Drive to place 4th specimen
                                outtakeSlide.specimenDrop(),
                                outtakeClaw.dropPosition()
                        ),
                        outtakeSlide.specimenDropDown(),    //Place 4th specimen
                        new ParallelAction(
                                followDumbName8Path,        //Drive to get 5th specimen
                                new SequentialAction(
                                        new SleepAction(.1),
                                        outtakeClaw.open()
                                )
                        ...
                        outtakeSlide.extendAction(),
                        new ParallelAction(
                                followOhDip9Path,           //Drive to place 5th specimen
                                outtakeSlide.specimenDrop(),
                                outtakeClaw.dropPosition()
                        ),
                        outtakeSlide.specimenDropDown(),    //Place 5th specimen
                        new ParallelAction(
                                followBackToZonePath,       //Drive to park
                                new SequentialAction(
                                        new SleepAction(.1),
                                        outtakeClaw.open()
                                )
